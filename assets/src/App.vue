...
<template>
  <div>
  <div><h2>Symbolic Execute Terminal</h2>
  <br>
  <br>
<p>We design and implements a Linux kernel static analysis system based on LLVM.</p> 
<br> 
The system can use PeX based indirect call analysis technology to build a complete
<br> <br>
 function call graph, find out all suspicious bug paths, and use the symbolic execution
<br> <br>
symbolic execution engine based on Deadline and KUBO to verify these paths one by one. 
<br><br>
The system is generally applicable to the verification of possible trigger paths of
<br><br>
different kinds of bugs in the kernel, and it is modular design so taht each analysis
<br><br>
function can be relatively independent. This paper also uses the system to analyze the
<br> <br>
kernel, verify the PeX outputing permission check bugs, and comprehensively evaluates 
<br><br>
the system.
  </div>
  <div
